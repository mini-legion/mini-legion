...
export const GuideDetail = () => {
        ...
        return (
          <div key={index} className="guide-section">
            ...
            <div className="rounded-2xl border border-red-500/20 bg-gradient-to-br from-slate-900 to-slate-950 p-4 shadow-xl shadow-red-500/10">
              <div className="relative w-full overflow-hidden rounded-xl border border-slate-800 bg-black" style={{ paddingBottom: '56.25%', minHeight: 220 }}>
                <iframe
                  src={embedUrl}
              ...
              <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <a href={watchUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center rounded-xl bg-red-500 px-4 py-2 text-sm font-black text-white hover:bg-red-400 transition-colors">
                  ▶ Open on YouTube
                </a>
              </div>
            </div>
  ...
  return (
    <div className="guide-detail">
      ...
      <div className="guide-body"><div className="guide-intro"><p>{guide.description}</p></div><div className="guide-content">{guide.sections.map((section, index) => renderSection(section, index))}</div><div className="guide-footer"><Link to="/guides" className="guide-back-btn"><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" /></svg>Back to Guides</Link></div></div>
